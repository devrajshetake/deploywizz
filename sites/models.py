...
class Site(models.Model):
    ...
    # virtual_machine = models.ForeignKey('automation.VirtualMachine', on_delete=models.CASCADE, default=1, related_name='sites_deployed')
...
class Deployment(models.Model):
    ...
    site = models.ForeignKey('Site', on_delete=models.CASCADE, default=1, related_name='deployments')
